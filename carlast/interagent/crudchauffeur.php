...
<script language="javascript">
  function non_vide () {
    var nom=window.document.form.nom.value;
    var cin=window.document.form.cin.value;
    if (nom=="" || cin=="")
      alert("L'un des champs est vide");
    else if (cin.length!=8)
    {
      alert("Cin incomplete");
    }
    else if (!parseInt(cin))
    {
      alert("Cin Errone");
    }
    else alert("Le nom : "+nom+"\nLe Cin : "+cin);
  }
</script>
    ...
    <div class="col-md-4">
      ...
      <div class="card card-body">
        <form action="ajoutchauf.php" method="POST" name="form">
          ...
          <div class="form-group">
            <input type="text" name="cin" class="form-control" placeholder="CIN" autofocus>
          </div>
          <div class="form-group">
            <input type="text" name="numtel" class="form-control" placeholder="Numero de télephone" autofocus>
          </div>
          <input type="submit" name="ajoutchauf" class="btn btn-success btn-block" value="Sauvegarder" onclick="non_vide()"/>
        </form>
      </div>
    </div>
    <div class="col-md-8">
