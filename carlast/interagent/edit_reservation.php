...
if (isset($_POST['update'])) {
  ...
  $query = "UPDATE reservation set reservation = '$reservation', client = '$client',voiture = '$voiture',depart ='$depart',retour = '$retour',livraison = '$livraison', etat = '$etat', prix = '$prix'  WHERE id=$id";
  ...
  <div class="row">
    <div class="col-md-4 mx-auto">
      ...
      <div class="form-group">
          ...
          <input type="text" name="reservation" class="form-control" value="<?php echo $reservation; ?>" placeholder="ID réservation">
        </div>
        <div class="form-group">
          <a1>ID Client : </a1>
          <input type="text" name="client" class="form-control" value="<?php echo $client; ?>" placeholder="ID client">
          </div>
          <div class="form-group">
          <a1>ID voiture : </a1>
          <input type="text" name="voiture" class="form-control" value="<?php echo $voiture; ?>" placeholder="voiture">
          </div>
          <div class="form-group">
            <a1>Départ : </a1>
