...
<input type="text" name="cin" class="form-control" placeholder="cin"   maxlength="8" pattern="[0-9]{8,}"  required oninvalid="setCustomValidity('le cin doit contenir 8 chiffres')" oninput="setCustomValidity('')" autofocus>
                    ...
                    <div class="form-group">
                      <input type="date" name="debut" class="form-control" placeholder="Date de debut" required pattern="\d{4}-\d{2}-\d{2}"  required oninvalid="setCustomValidity('veuillez saisir une date de naissance valide')" oninput="setCustomValidity('')" autofocus>
                    </div>
                    <div class="form-group">
                      <input type="date" name="fin" class="form-control" placeholder="fin" required pattern="\d{4}-\d{2}-\d{2}" required oninvalid="setCustomValidity('veuillez saisir une date de naissance valide')" oninput="setCustomValidity('')" autofocus>
                    </div>
                    <div class="form-group">
